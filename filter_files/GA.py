...
async def read_item(item: Item): # 参数类型是
    ...
    lowers_x[0][0] = lowers_x[0][0] - 0.05
    ...
    x1 = [(L1 - 1 - 18) / (48 - 18), (L1 + 1 - 18) / (48 - 18)]
    x2 = [(L2 - 1 - 15.5) / (48.5 - 15.5), (L2 + 1 - 15.5) / (48.5 - 15.5)]
    x3 = [(2 - 2) / (3.2 - 2), (2.6 - 2) / (3.2 - 2)]
    x4 = [(3.2 - 3.2) / (4.7 - 3.2), (4.0 - 3.2) / (4.7 - 3.2)]
    b1 = [1, 1]
    b2 = [1, 1]
